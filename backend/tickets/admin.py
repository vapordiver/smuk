...
from .models import Ticket, Building, FaultCategory, Comment, AuditLog
...
class TicketAdmin(admin.ModelAdmin):
    list_display = ('id', 'title', 'category', 'building', 'status', 'priority', 'reporter', 'created_at')
...
class AuditLogAdmin(admin.ModelAdmin):
    list_display = ('id', 'ticket', 'user', 'field_changed', 'old_value', 'new_value', 'created_at')
    ...
    readonly_fields = ('ticket', 'user', 'field_changed', 'old_value', 'new_value', 'created_at')
...
class CommentAdmin(admin.ModelAdmin):
    list_display = ('id', 'ticket', 'user', 'short_text', 'created_at')
    list_filter = ('created_at',)
    readonly_fields = ('id', 'created_at')

    # trim the text so the comment doesn't destroy the layout
